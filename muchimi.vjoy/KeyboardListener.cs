...
// adapted from https://github.com/rvknth043/Global-Low-Level-Key-Board-And-Mouse-Hook
// to add scancode reading as well as virtual key reading
...
namespace muchimi_vjoy
{
    ...
    public class KeyboardHook
    {
        ...
        public delegate void KeyboardHookCallback(VKeys key, int scanCode, bool is_extended);
        ...
        public class KBDLLHOOKSTRUCT
        {
            ...
            {
                return string.Format("vkCode={0}, scanCode={1}, flags=[{2}], time={3}, dwExtraInfo={4}", vkCode,
                    scanCode, flags, time, dwExtraInfo);
            }
        }
        ...
        /// <summary>
        /// Default hook call - key up/key down
        /// </summary>
            ...
            if (nCode >= 0)
            {
                ...
                if ((iwParam == WM_KEYDOWN || iwParam == WM_SYSKEYDOWN))
                    if (KeyDown != null)
                    {
                        ...
                        isExtended = (data.flags & KBDLLHOOKSTRUCTFlags.LLKHF_EXTENDED) != 0;
                        KeyDown((VKeys)data.vkCode, (int)data.scanCode, isExtended);
                    }
                ...
                if ((iwParam == WM_KEYUP || iwParam == WM_SYSKEYUP))
                    if (KeyUp != null)
                    {
                        KBDLLHOOKSTRUCT data = Marshal.PtrToStructure<KBDLLHOOKSTRUCT>(lParam);
                        isExtended = (data.flags & KBDLLHOOKSTRUCTFlags.LLKHF_EXTENDED) != 0;
                        KeyUp((VKeys)data.vkCode, (int)data.scanCode, isExtended);
                    }
