...
namespace vJoy.Wrapper
{
    ...
    public class VirtualJoystick : IDisposable
    {
        ...
        /// <returns></returns>
        public int GetJoystickAxis(Axis usage)
        {
            Joystick.UpdateVJD(JoystickId, ref State);
            switch (usage)
            {
                ...
                case Axis.HID_USAGE_RX:
                    return State.AxisXRot;
                    
                case Axis.HID_USAGE_RY:
                    return State.AxisYRot;
                    
                case Axis.HID_USAGE_RZ:
                    return State.AxisZRot;
        ...
        /// <returns></returns>
        public int GetJoystickHat(Hats hat)
        {
            Joystick.UpdateVJD(JoystickId, ref State);
            switch (hat)
            {
                case Hats.Hat:
                    return (int)State.bHats;
                    
                case Hats.HatExt1:
                    return (int)State.bHatsEx1;;
                    
                case Hats.HatExt2:
                    return (int)State.bHatsEx2;;
                    
                case Hats.HatExt3:
                    return (int)State.bHatsEx3;
            }
